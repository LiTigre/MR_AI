...
# my_dataset_test = CustomDatasetFromImages("/Users/li-tigre/Desktop/new_data/test_names.csv", "/Users/li-tigre/Desktop/data/Test")

# my_dataset_val = CustomDatasetFromImages("/Users/li-tigre/Desktop/new_data/val_names.csv", "/Users/li-tigre/Desktop/data/Validation")

my_dataset_train = CustomDatasetFromImages("/Users/li-tigre/Desktop/new_data/val_names.csv", "/Users/li-tigre/Desktop/new_data/Validation")
...
#         'in_channel': 3,   #to change depending on input
    ...
    'conv2': {
        'in_channel': 4, #refer to conv1_out_channel
        'out_channel': 8,
        'kernel_size': 3,
        'stride': 1
    },
    ...
    #13, 13, 256
    'conv8': {
        'in_channel': 256, #refer to conv1_out_channel
        'out_channel': 512,
        'kernel_size': 3,
        'stride': 1
    },
...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.conv6 = nn.Conv2d(in_channels = params['conv6']['in_channel'], 
                               out_channels = params['conv6']['out_channel'], 
                               kernel_size = params['conv6']['kernel_size'], 
                               stride=params['conv6']['stride'])
        
        self.batch6 = nn.BatchNorm2d(params['conv6']['out_channel'], eps=1e-5, momentum=0.1, affine=True)

        self.conv7 = nn.Conv2d(in_channels = params['conv7']['in_channel'], 
                               out_channels = params['conv7']['out_channel'], 
                               kernel_size = params['conv7']['kernel_size'], 
                               stride=params['conv7']['stride'])
        
        self.batch7 = nn.BatchNorm2d(params['conv7']['out_channel'], eps=1e-5, momentum=0.1, affine=True)

        self.conv8 = nn.Conv2d(in_channels = params['conv8']['in_channel'], 
                               out_channels = params['conv8']['out_channel'], 
                               kernel_size = params['conv8']['kernel_size'], 
                               stride=params['conv8']['stride'])
        
        self.batch8 = nn.BatchNorm2d(params['conv8']['out_channel'], eps=1e-5, momentum=0.1, affine=True)
    ...
    def forward(self, x):
        ...
        out = self.max2d(self.relu(self.batch6(self.conv6(out))))
        out = self.max2d(self.relu(self.batch7(self.conv7(out))))
        out = self.max2d(self.relu(self.batch8(self.conv8(out))))
...
def save_model(epoch, model, path='/Users/li-tigre/Desktop/new_data/model/'):
...
path = '/Users/li-tigre/Desktop/new_data/model/'
...
for epoch in range(1, numEpochs + 1):
    ...
    # val_accuracies.append(valnew_acc)
